  ...
  return (
    <>
      <div className="min-h-[100vh]  relative  mx-auto p-10  ">
        ...
        <div className="flex  pt-20 items-center  justify-center text-center ">
          <div className="flex flex-col gap-10 text-left max-w-2xl w-full">
            ...
            <div className="flex flex-col gap-3 max-h-[600px] overflow-y-auto ">
              <p className="text-white/50 text-lg  leading-relaxed">
                ...
                entnehmen. Wie erfassen wir Ihre Daten? Ihre Daten werden zum
                einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei
                ...
                Website betreten. Wofür nutzen wir Ihre Daten? Ein Teil der
                ...
                bezüglich Ihrer Daten? Sie haben jederzeit das Recht,
                ...
                außerdem ein Recht, die Berichtigung oder Löschung dieser Daten
                ...
                unserer Website bei folgendem Anbieter: All-Inkl Anbieter ist
                die ALL-INKL.COM - Neue Medien Münnich, Inh. René Münnich,
                Hauptstraße 68, 02742 Friedersdorf (nachfolgend All-Inkl).
                Details entnehmen Sie der Datenschutzerklärung von All-Inkl:
                https://all-inkl.com/datenschutzinformationen/. Die Verwendung
                von All-Inkl erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
                DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst
                zuverlässigen Darstellung unserer Website. Sofern eine
                ...
                TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar. 3.
                ...
                für die Datenverarbeitung auf dieser Website ist: Ulugbek
                Kobulov Friedrichshafen, Deutschland Telefon: +49 1515 733 88 40
                E-Mail: contact@ulugbek-kobulov.com Verantwortliche Stelle ist
                ...
                E-Mail-Adressen o. Ä.) entscheidet. Speicherdauer Soweit
                ...
                Gründe. Allgemeine Hinweise zu den Rechtsgrundlagen der
                Datenverarbeitung auf dieser Website Sofern Sie in die
                Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre
                personenbezogenen Daten auf Grundlage von Art. 6 Abs. 1 lit. a
                ...
                Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1 lit.
                ...
                dieser Datenschutzerklärung informiert. Empfänger von
                personenbezogenen Daten Im Rahmen unserer Geschäftstätigkeit
                arbeiten wir mit verschiedenen externen Stellen zusammen. Dabei
                ist teilweise auch eine Übermittlung von personenbezogenen Daten
                an diese externen Stellen erforderlich. Wir geben
                personenbezogene Daten nur dann an externe Stellen weiter, wenn
                dies im Rahmen einer Vertragserfüllung erforderlich ist, wenn
                wir gesetzlich hierzu verpflichtet sind (z. B. Weitergabe von
                Daten an Steuerbehörden), wenn wir ein berechtigtes Interesse
                ...
                geschlossen. Widerruf Ihrer Einwilligung zur Datenverarbeitung
                ...
                besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO) WENN
                DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E
                ...
                Beschwerde­recht bei der zuständigen Aufsichts­behörde Im Falle
                von Verstößen gegen die DSGVO steht den Betroffenen ein
                ...
                auf Daten­übertrag­barkeit Sie haben das Recht, Daten, die wir
                ...
                technisch machbar ist. Auskunft, Berichtigung und Löschung Sie
                ...
                jederzeit an uns wenden. Recht auf Einschränkung der
                Verarbeitung Sie haben das Recht, die Einschränkung der
                ...
                Datenverarbeitung verlangen. Wenn wir Ihre personenbezogenen
